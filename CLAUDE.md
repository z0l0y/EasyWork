...
EasyWork 是一个 Claude Code 技能生态系统，提供 28 个专业技能 + 流水线编排 + 网状自治分析。覆盖从需求理解、代码实现、审查、测试、复盘到 CTO 拷打的完整研发生命周期。

---

## 🚪 从哪里开始？

**你不需要记住 28 个技能名或 29 条命令。** 只需用自然语言描述你想做什么，Agent 自动匹配最合适的技能：
...
- 斜杠命令位于 `.claude/commands/easywork/`（29 条命令）
